...
public class CategorieProduitController {
	...
	@ResponseBody
	public CategorieProduit retrieveCategorieProduit(@PathVariable("categorieProduit-id") Long categorieProduitId, CategorieProduit cp) {
		return categorieProduitService.retrieveCategorieProduit(categorieProduitId, cp);
	}
